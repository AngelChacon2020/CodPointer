...
; Colors
ALIEN_COLOR         equ 05h ; le cambie el color a magenta  ; Green
PLAYER_COLOR        equ 01h  ;le cambie el color a azul  ; Gray
BARRIER_COLOR       equ 0Ah ; le cambie color a azul claro  ; Red
PLAYER_SHOT_COLOR   equ 00h ;le cambie color al disparo a negro  ; Cyan
ALIEN_SHOT_COLOR    equ 04h ;el disparo de el alies ahora es rojo  ; Yellow
